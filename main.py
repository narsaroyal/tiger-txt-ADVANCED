...
bot = Client("bot",
             bot_token= "6847591791:AAHBJeZ_4jDvDHDwllDxs5v0sS2Q5IDiAyw",
             api_id=26033579,
             api_hash= "33a934bc26568850ed0eb2c829817090")


@bot.on_message(filters.command(["start"]) & filters.user(ADMINS))
async def account_login(bot: Client, m: Message):
    editable = await m.reply_text(f" BOT MADE BY ROYAL [{m.from_user.first_name}](tg://user?id={m.from_user.id})\nPress /ROYAL")
...
@bot.on_message(filters.command(["ROYAL"]) & filters.user(ADMINS))
async def account_login(bot: Client, m: Message):
